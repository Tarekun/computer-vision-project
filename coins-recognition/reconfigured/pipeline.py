"""End-to-end entrypoint for the reconfigured pipeline: detection (shared, unchanged,
from common/detection.py) + fixed/tuned classification, wired to the same interface as
coins-recognition/pipeline.py's initialize_ght/evaluate. See ANALYSIS.md and
reconfigured/README.md for what changed vs giacomo/tiziano and why.
"""
